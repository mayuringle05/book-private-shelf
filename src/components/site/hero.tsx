      ...
      <div className="book-shell relative z-10 flex min-h-[100svh] flex-col justify-between pb-32 pt-28 md:pb-12 md:pt-32">
        ...
        <div className="py-16 md:py-20 lg:py-24">
          <GooeyTextReveal mode="immediate" duration={1.35} stagger={0.12} className="max-w-[1220px]">
            <h1 data-gooey-reveal-item className="book-display book-display-hero text-[var(--book-ink)]">
              Attraction is<br />a language.
            </h1>
            <p data-gooey-reveal-item className="book-display book-display-lg mt-8 max-w-5xl text-[var(--book-copper)]">
